...
function Dev(msg) 
ok = false
local list = {Sudo_Id,5634805056,5477138510,1715562844}
...
data = {
{
{text = 'الحماية ♡',type = 'text'},{text = 'الاغاني♡',type = 'text'},
},
}
}
...
env:write("API_ID = "..app_id.."\nAPI_HASH = "..api_hash.."\nBOT_TOKEN = "..token.."\nMONGO_DB_URI = mongodb+srv://Zohary23:ZOHARY23@cluster0.kgxrztg.mongodb.net/?retryWrites=true&w=majority\nLOG_GROUP_ID = "..gp_id.."\nMUSIC_BOT_NAME = "..userbot.."\nSTRING_SESSION = "..session.."\nOWNER_ID = "..dev_id.."\nBOT_USER ="..userbot.."\nDEV_BOT ="..dev_id.."\nUSER_OWNER ="..dev_user.."")
env:close()
sleep(3)
...
send(msg.chat_id,msg.id,"• | اهلا بك ف مصنع بوتات الاغاني \n • | اضغط على صنع بوت لتنصيب بوتك ","md",true, false, false, true, reply_markup)
return false 
end
---making user
if text and text:match("^@(.*)") and Redis:get(Fast..data.sender_id.user_id.."ch:7oda") then
